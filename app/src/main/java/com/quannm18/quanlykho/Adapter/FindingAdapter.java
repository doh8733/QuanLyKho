...
public class FindingAdapter extends RecyclerView.Adapter<FindingAdapter.FindingHolder>{
    ...
    @NonNull
    @Override
    public FindingAdapter.FindingHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull FindingAdapter.FindingHolder holder, int position) {
